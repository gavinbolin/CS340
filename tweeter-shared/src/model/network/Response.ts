...
export class TweeterResponse {
  ...
  static fromJson(res: JSON): TweeterResponse {
...
export class AuthenticateResponse extends TweeterResponse { // login and register
  ...
  static fromJson(res: JSON): AuthenticateResponse {
    interface AuthenticateResponseJson extends ResponseJson { //INTERFACE NEEDS TO MATCH JSON NAMING sEXACTLY
      _user: JSON;
      _token: JSON;
    }
    const jsonObject: AuthenticateResponseJson = res as unknown as AuthenticateResponseJson;
    // console.log("WHAT IS THIS>>>>", jsonObject);
...
export class GetUserResponse extends TweeterResponse {
  ...
  static fromJson(res: JSON): GetUserResponse {
    ...
    const deserializedUser = User.fromJson(JSON.stringify(jsonObject._user));
    if (deserializedUser === undefined) { throw new Error("AuthenticateResponse, could not deserialize user with json:\n" + JSON.stringify(jsonObject._user));}
...
export class LoadStatusItemsResponse extends LoadMoreItemsResponse<Status>{
  static fromJson(res: JSON): LoadStatusItemsResponse {
    ...
    if (deserializedItems === null || deserializedItems === undefined) { throw new Error("LoadStatusItemsResponse, could not deserialize Status with json:\n" + JSON.stringify(jsonObject._items)); }
    else if (deserializedItems === undefined) { throw new Error("LoadStatusItemsResponse, could not deserialize Statuses due to Undefined variables:\n" + JSON.stringify(jsonObject._items)); }
...
export class LoadUserItemsResponse extends LoadMoreItemsResponse<User>{
  static fromJson(res: JSON): LoadUserItemsResponse {
    interface itemResponseJson extends ResponseJson { //error using T in static method
      _items: JSON[];
      _moreItems: boolean;
    }
    ...
    if (deserializedItems === null) { throw new Error("LoadUserItemsResponse, could not deserialize user with json:\n" + JSON.stringify(jsonObject._items)); }
    else if (deserializedItems === undefined) { throw new Error("LoadUserItemsResponse, could not deserialize Users due to Undefined variables:\n" + JSON.stringify(jsonObject._items)); }
...
export class GetPrimitiveResponse extends TweeterResponse{
  ...
  static fromJson(res: JSON): GetPrimitiveResponse {
...
export class FollowResponse extends TweeterResponse{
  ...
  static fromJson(res: JSON): FollowResponse {
